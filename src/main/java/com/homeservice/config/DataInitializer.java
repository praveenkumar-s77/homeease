...
public class DataInitializer {
    ...
    CommandLineRunner initData(UserRepository userRepo, ServiceCategoryRepository categoryRepo,
                               WorkerRepository workerRepo, PasswordEncoder encoder) {
        return args -> {
            // Create admin user
            ...
            // Create demo worker user account
            User workerUser = null;
            if (!userRepo.existsByUsername("worker")) {
                workerUser = new User("worker", encoder.encode("worker123"),
                        "Manjunath Gowda", "manjunath@homeservice.com", "9876543201", User.Role.WORKER);
                workerUser.setPermanentAddress("Kengeri, Bangalore 560059");
                userRepo.save(workerUser);
            } else {
                workerUser = userRepo.findByUsername("worker").orElse(null);
            }
            ...
            Worker w1 = new Worker(); w1.setName("Ramesh Kumar"); w1.setPhone("7777777771");
            ...
            w1.setIdType(Worker.IdType.AADHAAR); w1.setIdNumber("XXXX-XXXX-1234"); w1.setVerified(true);
            workerRepo.save(w1);

            Worker w2 = new Worker(); w2.setName("Suresh Sharma"); w2.setPhone("7777777772");
            ...
            w2.setIdType(Worker.IdType.PAN); w2.setIdNumber("ABCDE1234F"); w2.setVerified(true);
            workerRepo.save(w2);

            Worker w3 = new Worker(); w3.setName("Mohan Singh"); w3.setPhone("7777777773");
            ...
            w3.setIdType(Worker.IdType.DRIVING_LICENCE); w3.setIdNumber("DL-1234567890"); w3.setVerified(true);
            workerRepo.save(w3);

            Worker w4 = new Worker(); w4.setName("Vikram Yadav"); w4.setPhone("7777777774");
            ...
            w4.setIdType(Worker.IdType.AADHAAR); w4.setIdNumber("XXXX-XXXX-5678"); w4.setVerified(true);
            workerRepo.save(w4);

            Worker w5 = new Worker(); w5.setName("Ajay Verma"); w5.setPhone("7777777775");
            ...
            w5.setIdType(Worker.IdType.PAN); w5.setIdNumber("FGHIJ5678K"); w5.setVerified(false);
            workerRepo.save(w5);

            Worker w6 = new Worker(); w6.setName("Deepak Negi"); w6.setPhone("7777777776");
            ...
            w6.setIdType(Worker.IdType.AADHAAR); w6.setIdNumber("XXXX-XXXX-9012"); w6.setVerified(true);
            workerRepo.save(w6);

            // --- Kengeri, Bangalore 560059 workers ---

            Worker k1 = new Worker(); k1.setName("Manjunath Gowda"); k1.setPhone("9876543201");
            ...
            k1.setIdType(Worker.IdType.AADHAAR); k1.setIdNumber("XXXX-XXXX-3456"); k1.setVerified(true);
            k1.setUser(workerUser);
            workerRepo.save(k1);

            Worker k2 = new Worker(); k2.setName("Ravi Naik"); k2.setPhone("9876543202");
            ...
            k2.setIdType(Worker.IdType.PAN); k2.setIdNumber("KLMNO6789P"); k2.setVerified(true);
            workerRepo.save(k2);

            Worker k3 = new Worker(); k3.setName("Srinivas Reddy"); k3.setPhone("9876543203");
            ...
            k3.setIdType(Worker.IdType.DRIVING_LICENCE); k3.setIdNumber("KA-DL-2024-78901"); k3.setVerified(true);
            workerRepo.save(k3);

            Worker k4 = new Worker(); k4.setName("Venkatesh B"); k4.setPhone("9876543204");
            ...
            k4.setIdType(Worker.IdType.AADHAAR); k4.setIdNumber("XXXX-XXXX-7890"); k4.setVerified(true);
            workerRepo.save(k4);

            Worker k5 = new Worker(); k5.setName("Nagesh M"); k5.setPhone("9876543205");
            ...
            k5.setIdType(Worker.IdType.PAN); k5.setIdNumber("QRSTU1234V"); k5.setVerified(true);
            workerRepo.save(k5);
        };
    }
}
